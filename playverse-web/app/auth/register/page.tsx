      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800/50 border border-orange-400/30 rounded-lg p-6">
          ...
          <div className="grid gap-3">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" className="flex-shrink-0" fill="#107C10" aria-hidden="true">
                <path d="M12 2c-3.5 0-6.7 1.7-8.7 4.4 2.1 1.5 4 3.3 5.6 5.4-1.6 2.1-3.5 3.9-5.6 5.4A10.02 10.02 0 0 0 12 22c3.5 0 6.7-1.7 8.7-4.4-2.1-1.5-4-3.3-5.6-5.4 1.6-2.1 3.5-3.9 5.6-5.4A10.02 10.02 0 0 0 12 2Zm0 4.5c.9.8 1.8 1.7 2.6 2.7L16 10c-.9-1.3-2-2.5-3.1-3.6l-.9-.9Zm-2.6 2.7c.8-1 1.7-1.9 2.6-2.7l-1 .9C9.9 9.5 8.8 10.7 7.9 12l.6-.8Zm0 7.6 1 .9c.9-.8 1.8-1.7 2.6-2.7l-1 .9c-.9.9-2 2.1-2.6 2.7ZM16 14c-.9 1.3-2 2.5-3.1 3.6l.9.9c.9-.8 1.8-1.7 2.6-2.7L16 14Z" />
              </svg>
              Continuar con Xbox
            </button>
          </div>
